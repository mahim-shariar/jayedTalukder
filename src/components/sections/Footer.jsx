...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className="relative bg-gray-900 text-gray-300 border-t border-gray-800 overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <nav
            ref={linksRef}
            className="grid grid-cols-2 md:flex gap-6 md:gap-8 mb-8 md:mb-0"
          >
            {["About", "Work", "Contact", "Reel"].map((link, i) => (
              <motion.a
                key={link}
